...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans overflow-x-hidden">
      <section className="max-w-5xl mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div className="order-2 md:order-1">
          <h1 className="text-3xl md:text-4xl tracking-tight font-extrabold text-gray-900 mb-3">
            Hi, I'm <br className="hidden md:block" /> Zulkaif Ahmad.
          </h1>
          <p className="mb-5 text-base md:text-lg tracking-tight font-medium">
            HTML | CSS | JavaScript | React.js | Redux-Toolkit | React-Router-DOM | Tailwind CSS | Git & Github
          </p>
          <p className="text-base md:text-lg text-gray-600 tracking-tight leading-relaxed mb-6">
        ...
        <div className="order-1 md:order-2 bg-gray-200 rounded-2xl aspect-square flex items-center justify-center overflow-hidden shadow-lg border border-gray-300 w-full max-w-sm mx-auto md:max-w-none">
          <img
            src={pic}
            alt="Zulkaif Ahmad"
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-12 py-10 md:py-12">
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-12 py-10 md:py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">My Education</h2>
        <div className="flex flex-col gap-6">
          <ExperienceCard
            startDate="2023"
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-12 py-10 md:py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Technical Arsenal</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-12 py-10 md:py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">My Journey & Vision</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-12 py-12 md:py-16 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Beyond the Screen</h2>
        ...
        <div className="bg-gray-900 rounded-2xl md:rounded-3xl p-6 md:p-12 text-white shadow-xl">
          <h3 className="text-xl md:text-2xl font-bold mb-4">
            Let's Build Something Great Together.
          </h3>
          <p className="text-sm md:text-base text-gray-300 mb-8 max-w-2xl mx-auto px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              onClick={() => navigate("/contact")}
              className="w-full sm:w-auto px-6 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors"
            >
              Reach Out
            </button>
            <button className="w-full sm:w-auto px-6 py-3 bg-transparent border border-gray-600 text-white font-semibold rounded-lg hover:border-gray-400 hover:text-gray-100 transition-colors">
              View My Resume
            </button>
          </div>
        </div>
